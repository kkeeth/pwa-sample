(function () {
	...
	function $$1(selector, ctx) {
	  return domToArray$1(typeof selector === 'string' ? (ctx || document).querySelectorAll(selector) : selector);
	}
	...
	function parseNodes(els, name, method) {
	  ...
	  return normalize(domToArray$1(els).map(el => {
	...
	var require$$0 = /*@__PURE__*/getAugmentedNamespace(riot_esm);
	...
	var require$$1 = /*@__PURE__*/getAugmentedNamespace(index_next);
	...
	var ColorPalette = {
	  ...
	  'template': function(
	    ...
	    return template(
	      '<h2>Riot Color Palette</h2><div expr1="expr1"></div><p>Click the color👆</p>',
	      [
	        {
	...
	var App = {
	  'css': `app,[is="app"]{ position: absolute; top: 0; right: 0; bottom: 0; left: 0; padding: 1em; text-align: center; background: #eee; }`,
	  ...
	  'template': function(
	    ...
	    return template(
	      '<color-palette expr0="expr0"></color-palette>',
	      [
	        {
	          'expressions': [
	            {
